...
object ChallengeSix : Challenge(1, 6) {
    override fun passes(): Boolean {
        val providedCiphertext = File("src/main/resources/challengedata/6.txt").readText().filter { it != '\n' }.base64ToBytes()
        ...
        val keySize = findRepeatingKeyXorKeySize(providedCiphertext, providedMaxPossibleKeySize)

        val blocks = transpose(providedCiphertext, keySize)
