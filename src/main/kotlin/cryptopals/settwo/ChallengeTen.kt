...
object ChallengeTen: Challenge(2, 10) {
    override fun passes(): Boolean {
        ...
        val providedCiphertextBytes = providedCiphertext.base64ToBytes()

        val decryptedPlaintextBytes = decryptWithAESInCBCMode(providedCiphertextBytes, providedKey, providedIV)
        val decryptedPlaintext = decryptedPlaintextBytes.toAscii()

        return decryptedPlaintext == expectedPlaintext
    }
}
